...
if __name__ == "__main__":
    ...
    parser.add_argument('-ds', '--dataset', dest='dataset', default='s',choices=['s','t'],
                        help="Dataset:\n\tSumMe: s\n\tTVSum: t\n(default: %(default)s)")
    parser.add_argument('-st', '--setting', dest='setting', default='c',choices=['c','a','t'],
                        help='Settings:\n\tCanonical: c\n\tAugmented: a\n\tTransfer : t\n(default: %(default)s)')
    parser.add_argument('-sh', '--shuffle', dest='shuffle', default=False, type=bool,
